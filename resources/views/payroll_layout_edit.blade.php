...
<head>
    ...
    <style>
        ...
        .payroll_id, #payroll_id_update, #rate_update, #attendance_update, #payroll_id_release, #rate_release, #attendance_release {
            display: none;
        }
        .track, .update {
            width: 50%;
...
<body>
    ...
    <script>
        ...
        let date1 = new Date(document.getElementById("date_start_update").value.toString());
        let date2 = new Date(document.getElementById("date_end_update").value.toString());
        
        let daysDiff = getDaysBetweenDates(date1, date2);
        let fullRate = daysDiff * document.getElementById("rate_update").value;
        let deductions =  (daysDiff - document.getElementById("attendance_update").value) * document.getElementById("rate_update").value;
        let total = fullRate - deductions;

        document.getElementById("salary_update").value = fullRate;
        document.getElementById("deductions_update").value = deductions;
        document.getElementById("total_update").value = total;
